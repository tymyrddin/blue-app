...
* [E2EE is not sacred](https://github.com/tymyrddin/amygdala-umbrella/tree/main/E2EE-threat-model). Protection from [SSL Spoofing](https://github.com/tymyrddin/darkest-forest/blob/main/application-hacking/HTTPS-spoofing.md) is required.
